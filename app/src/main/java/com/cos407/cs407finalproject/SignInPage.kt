...
class SignInPage : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.btnSignIn).setOnClickListener {
            ...
            validateUserCredentials(enteredUsername, enteredPassword)
        }
    }
            ...
            runOnUiThread {
                if (user != null && user.password == password) {
                    ...
                    val intent = Intent(this@SignInPage, MePage::class.java).apply {
                        putExtra("USER_EMAIL", user.email) // Pass the user's email to MePage
                    }
                    startActivity(intent)
                    ...
                    Toast.makeText(
                        this@SignInPage, "Incorrect username or password", Toast.LENGTH_SHORT
                    ).show()
                }
            }
        }
